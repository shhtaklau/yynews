        ...
        <div class="container">
            <div class="header">
                ...
                <div class="save-buttons">
                    <a href="../yymusic.html" class="toggle-wide-btn" style="text-decoration:none; display:inline-flex; align-items:center; gap:4px; font-size:13px;">🎧 洋洋听歌</a>
    ...
    html += """
            ...
            <div class="footer">
                <div class="footer-content">
                    由 <span class="project-name">洋洋大倌</span> 生成 ·
                    <a href="../yymusic.html" target="_blank" class="footer-link">
                      自用项目
                    </a>
                    <br>
                    <a href="../yymusic.html" class="footer-link">洋洋音乐</a>"""
